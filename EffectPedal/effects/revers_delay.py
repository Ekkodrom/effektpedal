...
class ReverseDelayEffect:
    ...
    def start_reverse_delay(self, in_bus=0, delay_time=0.7, feedback=0.5, wet=0.6, dry=0.4, reverse_blend=0.8, pitch_shift=0, stereo_spread=0.5, amp=1.0):
    ...
    def update_parameters(self, delay_time=None, feedback=None, wet=None, dry=None, reverse_blend=None, pitch_shift=None, stereo_spread=None, amp=None):
...
if __name__ == "__main__":
    ...
    reverse_delay.start_reverse_delay(delay_time=0.8, feedback=0.6, wet=0.7, dry=0.3, reverse_blend=0.9, pitch_shift=-3, stereo_spread=0.7, amp=1.2)